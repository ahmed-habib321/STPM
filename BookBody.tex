...
\subsection{Matrix and Determinant Differentiation}
...
\end{enrichment}
\end{figure*}
\begin{proof}[\textcolor{theme}{Proof the uniqueness}]
...
\end{enrichment}
\end{figure*}
\begin{proof}[\textcolor{theme}{Proof the existence synthetically}]
